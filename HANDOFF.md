...
- **Item 5 — legal wording (CORRECTION, meta-patterns §1):** the parked "MEH-1118/1119 legal-wording" line was **mislabeled**. MEH-1118 (dashboard conversion stat >100%) + MEH-1119 (stray page.js exports) are **GREEN code bugs**, not legal wording. The actual legal wording — **MEH-1058 (privacy, תיקון 13) #1585 + MEH-1059 (a11y, תקנה 35) #1584 — is already merged + Done.** Sapir gave her final wording sign-off ("מאשרת", in-session) — **no pending legal gate remains.** Per her call, MEH-1118 + MEH-1119 are now being fixed as a GREEN follow-up on this branch (after #1640 merges).
- **staging→main:** the single remaining gate is Sapir's (smoke dispatch → mobile spot-check → merge). Checklist posted to MEH-1074.
