...
- **Verify:** `npm run build` exit 0 (113/113 SSG) · vitest **733 passed** / 41 skipped (new `DashboardVacationDateReveal.test.jsx` 3✓) · JSON valid · 0 physical RTL classes added · package-lock churn from `npm install` reverted (fresh container).
