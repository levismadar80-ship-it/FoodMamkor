...
- **Branch:** `feature/meh-1171-manual-testing-conversion` off `origin/staging` (divergence 0 at cut). **Draft PR #1710** carries the merge-block marker in its title **by design** — the live marker gate self-blocks it until Sapir approves the matrix (ADR-016 amendment authority). `Refs MEH-1171`.
