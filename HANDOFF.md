...
## 2026-07-13 — MEH-1171 Ticket A conversion — checkpoints 7-11 (draft PR #1729, in progress)
...
- **Next (resume here):** continue CONVERT-PW sections in matrix order (navbar MEH-731 states are fragile/borderline-visual — needs class assertions or fixme; remaining strong read-only clusters: MEH-291 availability card, MEH-294 status labels, MEH-51 trust ladder). Then the **MANUAL_TESTING.md rewrite** (pointer stubs MEH-671 pattern + unified Tier-3 checklist + delete 138 approved STALE + KEEP-RUNBOOK verbatim), then full suite green ×2 pasted, then flip #1729 draft→ready with CHANGELOG+HANDOFF. **Watch Linear MEH-1176 for Sapir's F6/F7 resolutions — they take precedence.**
