...
## 2026-06-12 — MEH-133 /neighbor removal (DRAFT PR) — executes held LOCK sweep items 1+2

**Branch:** `feature/meh-133-remove-neighbor` off fresh `origin/staging` (divergence 0). Executes the home-cook LOCK sweep held below (2026-06-11) — item (1) legal clause + item (2) /neighbor feature copy. Sapir approved **removal** (not reframe) 2026-06-11; MEH-133 (the old /neighbor *refactor* ticket) repurposed as the removal ticket per her pick.
