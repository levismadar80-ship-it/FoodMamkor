...
## 2026-04-26 — MEH-338: chore(deps): bump fastapi 0.115.6→0.120.1, starlette 0.41.3→0.49.3 (CVE-2025-62727 + CVE-2025-54121). CVE-2025-62727 (CVSS 7.5-8.7): Range/FileResponse DoS — defense-in-depth (0 FileResponse/StaticFiles routes in codebase). CVE-2025-54121: multipart upload event-loop block — reachable via image upload routes; MEH-162 10MB cap mitigated blast radius but 1–10MB files still triggered pre-fix. annotated-doc 0.0.4 added as new fastapi 0.120.0+ dep. 148/148 tests green; rate-limit canary (TestRefreshTokenFlow::test_refresh_rate_limited) green on starlette 0.49.3. pip-audit BEFORE: 6 vulns in 3 pkgs; AFTER: 4 vulns in 2 pkgs (starlette CVEs gone, python-multipart+requests out-of-scope deferred to MEH-339/MEH-340).
