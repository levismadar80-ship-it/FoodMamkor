...
- **feat/map-ui-bugfixes** — 5 map UI bugs: bottom sheet z-[900]→z-[500] so zoom buttons aren't blocked, removed duplicate title tooltip on markers, added pb-6 to sheet against content cutoff, z-10 on X button, category legend hidden on mobile. Leaflet zoom CSS override `z-index: 1000 !important`.
