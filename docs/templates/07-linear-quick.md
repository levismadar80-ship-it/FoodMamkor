...
**Anchor חובה כשהמשימה נוגעת במשהו קיים.** `Line: [number, אם ידוע]` נשאר נכון
לקובץ חדש — אבל לקומפוננטה / קבוע / מחרוזת שכבר בקוד, ה-`file:line` אינו
אופציונלי: anchor אחד מאומת מול staging מספיק. אם לא מצאת אותו, המשימה כנראה
אינה quick — ואולי אינה קיימת.
