...
במיגרציה — התבנית של MEH-927. **הסמל פתוח לעריכה** גם על שורת מערכת (עמודת `emoji`
ב-DB; «סמל» הוא המונח שההודעה למשתמשת נוקטת, כי MEH-2163 מעביר את הגליפים
לרג'יסטרי לפי slug): לא הבדיקה
