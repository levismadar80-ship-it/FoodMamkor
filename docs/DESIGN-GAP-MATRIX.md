...
| HOME-06 | S14 → hero CTAs start-aligned; near-me border `--primary`; `גלו עסקים` | `HomeHero.jsx:135-166`: justify-center, near-me `border-border`, copy ✓ | Alignment + border token | 1 | S | GREEN | Copy matches MEH-472 locks. MEH-1070: alignment superseded 09/07 (Sapir) — centered; border-primary retained |
