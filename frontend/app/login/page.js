  ...
  return (
    <div className="min-h-[calc(100vh-200px)] flex items-center justify-center px-4 py-16">
      <div className="bg-white rounded-[20px] p-8 sm:p-10 w-full max-w-md border border-border shadow-[0_4px_32px_rgba(46,104,83,0.08)] text-center">
        ...
        {/* Bug fix: replaced sr-only "floating" labels with visible
            labels above each input. The previous sr-only-label + RTL
            placeholder pattern caused the placeholder text to render in
            the wrong visual direction and overlap typed content on iOS
            Safari. Visible labels match the /register pattern. */}
