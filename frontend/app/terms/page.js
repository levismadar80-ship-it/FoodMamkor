export const metadata = {
  ...
  description: "תנאי שימוש באתר מהמקור — פלטפורמה לחיבור בין יצרנים לקונים",
};
      ...
      <div className="bg-white rounded-[12px] p-8">
        ...
        <div className="space-y-8 text-text-primary leading-relaxed">
          <section>
            ...
            <p>
              מהמקור היא פלטפורמה לחיבור בין יצרנים ומוכרים לבין קונים. האתר אינו מוכר
              מוצרים בעצמו ואינו צד לעסקאות בין משתמשים.
            </p>
          </section>
