...
export default function MapPage() {
  ...
  const handleBoundsChange = useCallback((bounds) => {
    // Filter producers visible on the current map bounds
    // This is a client-side filter since we already have all producers
  }, []);
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-6">
      ...
      {/* Producer grid below map */}
      <div>
        <h2 className="text-xl font-bold mb-4">
          בתי עסק באזור ({producers.length})
        </h2>
