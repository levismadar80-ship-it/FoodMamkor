        ...
        <div className="bg-white rounded-[16px] border border-border shadow-sm p-6 md:p-8">
          ...
          <div className="mt-6 pt-5 border-t border-border">
            <a
              ...
              className="flex items-center justify-center gap-2 w-full border border-[#25D366] text-[#25D366] py-2.5 rounded-[10px] text-sm font-medium hover:bg-[#25D366]/5 transition"
            >
