...
export default function FavoriteButton({ producerId, className, style }) {
  const { user } = useAuth();
    ...
    <button
      ...
      className={
        className
          ...
          : "text-2xl hover:scale-110 transition focus-visible:ring-2 focus-visible:ring-primary/40 rounded p-2 disabled:opacity-60"
      }
      style={style}
