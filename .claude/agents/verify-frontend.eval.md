...
## T5a — rtl-ok marker on line above violation → suppressed (MEH-364)
...
## T5b — violation with no rtl-ok marker → counted (MEH-364)
...
## T5c — rtl-ok marker 2 lines above violation → counted (out of ±1 window) (MEH-364)
...
## T5d — rtl-ok marker on the violation line itself → suppressed (MEH-364)
...
## T5e — rtl-ok marker on line below violation → suppressed (MEH-364)
...
## T6 — frontend scan dir missing → loud failure (MEH-364 SCAN_DIR_MISSING)
