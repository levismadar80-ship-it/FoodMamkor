...
| `z-[1010]` | 2 | `components/AddressSearch.jsx:266` · `components/CitiesAutocomplete.jsx:281` | inline combobox suggestion lists. Above Leaflet panes (400), controls (1000) and attribution (1001); below the header. AddressSearch: MEH-2093 chunk A, fixing an observed clipping. CitiesAutocomplete: MEH-2102, **defensive alignment only** — measured 16/08, no current consumer places a map where that list can reach it |
