...
- מי שרוצה לפרסם מוצרים ביתיים נרשמת קודם כצרכנית ואז מפרסמת מוצרים דרך "מהמטבח של השכן" — אין צורך בהרשמה נפרדת.
...
- **מה זה "מהמטבח של השכן"?** — זו סקציה באתר שלנו שבה אפשר לפרסם מוצרים ביתיים (חלה של שישי, ריבה תוצרת בית, עוגיות וכו׳) לקהילה שלך. הצוות שלנו בודק כל מוצר לפני שהוא מופיע.
