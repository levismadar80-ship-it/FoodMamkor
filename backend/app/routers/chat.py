...
**מה זה מהמקור**
מהמקור זה אתר שמחבר בין אנשים שמחפשים אוכל אמיתי ומקומי לבין בתי עסק מקומיים — בשר במרעה, לחם מחמצת, חלב גולמי, ירקות אורגניים ועוד. אפשר לחפש לפי קטגוריה, לפי עיר, או על המפה לפי קרבה אליכם, ולדבר ישירות עם בית העסק.
...
**איך נרשמים כבית עסק**
נרשמים דרך טופס קצר — חינם לגמרי! 🎉
...
- **איך יוצרים קשר עם בית עסק?** — בכל עסק יש כפתור ליצירת קשר ישיר עם בית העסק — לרוב וואטסאפ, ולפעמים טלפון או ערוץ אחר שבית העסק בחר. אפשר גם לראות את הטלפון, האינסטגרם והאתר אם הוסיפו אותם.
