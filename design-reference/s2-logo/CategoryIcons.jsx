...
export function BreadIconSmall(props) {
  return (
    <Svg {...props}>
      <path d="M60 22 v76" />
...
// 05 — honey jar with dipper  (REASSIGNED: was OilIcon)
export function HoneyIcon(props) {
  return (
    <Svg {...props}>
...
// 06 — tied herb/soap bundle — foliage fan, gathered stems, WRAP BAND + knot, stem ends (not a planter)
export function SoapIcon(props) {
  return (
    <Svg {...props}>
      <path d="M60 22 v50" />
      <path d="M53 30 q-4 22 -1 42" />
      <path d="M67 30 q4 22 1 42" />
      <path d="M46 40 q5 -12 14 -16 q9 4 14 16" />
      <path d="M42 54 q7 -9 18 -11 q11 2 18 11" />
      <path d="M49 70 q11 4 22 0 q2 6 0 10 q-11 4 -22 0 q-2 -4 0 -10 z" />
      <path d="M60 66 q-5 -3 0 -7 q5 4 0 7" />
      <path d="M55 80 v7" />
      <path d="M60 81 v8" />
      <path d="M65 80 v7" />
    </Svg>
...
export function OilsIcon(props) {
  return (
    <Svg {...props}>
...
export function FruitIcon(props) {
  return (
    <Svg {...props}>
...
export function FermentsIcon(props) {
  return (
    <Svg {...props}>
...
export function PreparedIcon(props) {
  return (
    <Svg {...props}>
...
export function SpicesIcon(props) {
  return (
    <Svg {...props}>
...
export function BeveragesIcon(props) {
  return (
    <Svg {...props}>
...
export function ChocolateIcon(props) {
  return (
    <Svg {...props}>
...
export function MedicinalIcon(props) {
  return (
    <Svg {...props}>
...
export function CreamsIcon(props) {
  return (
    <Svg {...props}>
...
export function PreparationsIcon(props) {
  return (
    <Svg {...props}>
...
export function CandlesIcon(props) {
  return (
    <Svg {...props}>
...
export function SupplementsIcon(props) {
  return (
    <Svg {...props}>
